...
router.post('/trade', async (req, res) => {
    const { player_name, player_team, trade, trade_fantasy, created_at, updated_at} = req.body;
    ...
    const values = [player_name, player_team, trade, trade_fantasy, unixTimestamp, unixTimestamp];

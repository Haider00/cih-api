...
router.post('/news', async (req, res) => {
    const { tweet_id, tweet_text, tweet_created_at, tweet_updated_at, tweet_created_by } = req.body;
    ...
    const values = [ tweet_id, tweet_text, unixTimestamp, unixTimestamp, tweet_created_by];

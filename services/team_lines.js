...
router.post('/team_lines', async (req, res) => {
    const { team, position, player_id, player_name, player_image, created_at, updated_at} = req.body;
    ...
    const values = [team, position, player_id, player_name, player_image, unixTimestamp, unixTimestamp];
